    ...
    <div className="flex h-[calc(100vh-3.5rem)] overflow-hidden relative">
      ...
      >
        ...
        {emailDrawerOpen && (
          ...
          >
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-2 h-12 bg-muted-foreground/40 rounded-full opacity-0 group-hover:opacity-100 transition-opacity" />
          </div>
        )}
