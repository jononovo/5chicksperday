...
import { LogOut, User, Menu, LayoutDashboard, Mail, MessageCircle, Target, Headphones, Trophy } from "lucide-react";
...
const navigation = [
  ...
  { name: "Streak", href: "/streak", icon: "trophy" },
          ...
          return (
            ...
            >
              <div className="flex items-center">
                ...
                {item.icon === "trophy" && <Trophy className="mr-1 h-4 w-4" />}
